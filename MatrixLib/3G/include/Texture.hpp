...
inline int ConvertTexSize(ETexSize ts) { return (1 << ts); }
...
public:
    ...
    {
        if(m_OOM_counter > 0 || FLAG(m_Flags, TF_LOST)) return nullptr;
...
#pragma warning (default : 4355)
    ...
    {
#ifndef USE_DX_MANAGED_TEXTURES
            ASSERT_DX(TexFrom()->LockRect(0, &lr, nullptr, Flags));
#else
