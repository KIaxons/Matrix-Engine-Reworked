...
#else
inline void SetColorOp(int stage, D3DTEXTUREOP op, dword p1, dword p2) { g_D3DD->SetTextureStageState(stage, D3DTSS_COLOROP, op); g_D3DD->SetTextureStageState(stage, D3DTSS_COLORARG1, p1);  g_D3DD->SetTextureStageState(stage, D3DTSS_COLORARG2, p2); }
inline void SetAlphaOp(int stage, D3DTEXTUREOP op, dword p1, dword p2) { g_D3DD->SetTextureStageState(stage, D3DTSS_ALPHAOP, op); g_D3DD->SetTextureStageState(stage, D3DTSS_ALPHAARG1, p1);  g_D3DD->SetTextureStageState(stage, D3DTSS_ALPHAARG2, p2); }
inline void SetColorOpAnyOrder(int stage, D3DTEXTUREOP op, dword p1, dword p2) { SetColorOp(stage, op, p1, p2); }
inline void SetAlphaOpAnyOrder(int stage, D3DTEXTUREOP op, dword p1, dword p2) { SetAlphaOp(stage, op, p1, p2); }
inline void SetColorOpSelect(int stage, dword p){ g_D3DD->SetTextureStageState(stage, D3DTSS_COLOROP, D3DTOP_SELECTARG1 ); g_D3DD->SetTextureStageState(stage, D3DTSS_COLORARG1, p); g_D3DD->SetTextureStageState(stage, D3DTSS_COLORARG2, p);}
inline void SetColorOpDisable(int stage) { g_D3DD->SetTextureStageState(stage, D3DTSS_COLOROP, D3DTOP_DISABLE );}
inline void SetAlphaOpSelect(int stage, dword p){ g_D3DD->SetTextureStageState(stage, D3DTSS_ALPHAOP, D3DTOP_SELECTARG1 ); g_D3DD->SetTextureStageState(stage, D3DTSS_ALPHAARG1, p); g_D3DD->SetTextureStageState(stage, D3DTSS_ALPHAARG2, p);}
inline void SetAlphaOpDisable(int stage) { g_D3DD->SetTextureStageState(stage, D3DTSS_ALPHAOP, D3DTOP_DISABLE );}
#endif 
