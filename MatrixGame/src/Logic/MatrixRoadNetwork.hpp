...
public:
    ...
    bool IsNearestRegion(int reg1, int reg2);
    ...
    void ClearPL();
    void InitPL(int map_size_x, int map_size_y);
    CRect CorrectRectPL(const CRect& map_coords);
    void ActionDataPL(const CRect& map_coords, dword mask_and, dword mask_or = 0);
