...
public:
    ...
    D3DXVECTOR3 m_ShCampos = { 0.0, 0.0f, 0.0f };
    D3DXVECTOR2 m_ShDim = { 0.0f, 0.0f };

    EShadowType m_ShadowType = SHADOW_OFF; //SHADOW_PROJ_STATIC; //SHADOW_STENCIL;
...
public:
    ...
    void SetupMatricesForShadowTextureCalc();
    void MarkSpecialShadow() { SETFLAG(m_ObjectFlags, OBJECT_STATE_SHADOW_SPECIAL); }
    void Init(int ids);
