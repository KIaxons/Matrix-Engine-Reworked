...
//trace landscape
    ...
    second_scan_x:
                ...
                if(prevgy != gy1) scanhit = ScanLandscapeGroup(&data, gx1, gy1, start, end);
    ...
    scan_x_complete:;
        ...
        else
        {
            ...
            if(!gyc)
            {
                if((scanhit == SR_NONE) && (gxc != 0)) scanhit = ScanLandscapeGroup(&data, gx1, gy1, start, end);
            }
            else if((scanhit == SR_NONE))
            {
                int gcy;
    ...
    second_scan_y:
                ...
                if(prevgx != gx1) scanhit = ScanLandscapeGroup(&data, gx1, gy1, start, end);
