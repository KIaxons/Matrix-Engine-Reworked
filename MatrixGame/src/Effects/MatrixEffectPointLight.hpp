...
private:
    ...
    SPL_VBIB*   m_PrevFree = nullptr;
    SPL_VBIB*   m_NextFree = nullptr;
    SPL_VBIB*   m_PrevAll = nullptr;
    SPL_VBIB*   m_NextAll = nullptr;
...
public:
    ...
    D3D_VB DX_GetVB() { return m_VB; };
    D3D_IB DX_GetIB() { return m_IB; };
    ...
    bool DX_Ready() const { return IS_VB(m_VB) && IS_IB(m_IB); }
};
