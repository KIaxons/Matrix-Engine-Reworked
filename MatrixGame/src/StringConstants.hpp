...
//Ќадо будет нормально переделать загрузку этой херни, добавить пути руин в общий .cvo зданий
#define OBJECT_PATH_BUILDINGS_RUINS             L"Mods\\PlanetaryBattles\\PBEngine\\Matrix\\Building\\ruins\\"
...
#define ANIMATION_NAME_ROTATE_LEFT              L"Rotate" //‘изически на этих анимации должно проигрыватьс€ вращение влево
#define ANIMATION_NAME_BEGIN_ROTATE_LEFT        L"BeginRotate"
#define ANIMATION_NAME_END_ROTATE_LEFT          L"EndRotate"
#define ANIMATION_NAME_ROTATE_RIGHT             L"RotateRight"
#define ANIMATION_NAME_BEGIN_ROTATE_RIGHT       L"BeginRotateRight"
#define ANIMATION_NAME_END_ROTATE_RIGHT         L"EndRotateRight"
...
#define CFG_UNIT_SHADOWS                        L"UnitShadows"
#define CFG_BUILDING_SHADOWS                    L"BuildingShadows"
#define CFG_OBJECT_SHADOWS                      L"ObjectShadows"
#define CFG_SKY_BOX                             L"SkyBox"
#define CFG_OBJECTS_TO_MINIMAP                  L"ObjectsToMinimap"
...
#define PAR_SOURCE_RADAR_ROBOT_RADIUS           L"RobotRadarRadius"
#define PAR_SOURCE_RADAR_FLYER_RADIUS           L"FlyerRadarRadius"
...
#define PAR_SOURCE_WATER                        L"Map.Textures.Water"
#define PAR_SOURCE_WATER_WATER                  L"Water"
#define PAR_SOURCE_WATER_MIRROR                 L"Reflection"
#define PAR_SOURCE_WATER_INSHORE                L"InshoreWave"
...
#define PAR_SOURCE_CAMERA_MOVE_SPEED            L"CamMoveSpeed"
#define PAR_SOURCE_CAMERA_MOVE_SPEED_UP         L"CamMoveSpeedUp"
