...
#define DI_DRAW_FPS       SETBIT(0)
#define DI_VIS_OBJ        SETBIT(1)
#define DI_TMEM           SETBIT(2)
#define DI_TARGET_COORD   SETBIT(3)
#define DI_SIDE_INFO      SETBIT(4)
#define DI_ACTIVE_SOUNDS  SETBIT(5)
#define DI_FRUSTUM_CENTER SETBIT(6)
...
public:
    ...
    void ShowScreenText(const wchar* key, const wchar* val, int ttl = 3000, int bttl = 0, bool add = false);
